...
import com.repo.mongo.demo.model.ApiError;
...
public class CustomerServiceExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({CustomerNotFoundException.class, CustomerAlreadyExistException.class, CustomerIsNotEligibleToDelete.class})
